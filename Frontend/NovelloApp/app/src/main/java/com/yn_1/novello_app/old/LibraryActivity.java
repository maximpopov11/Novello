...
public class LibraryActivity extends AppCompatActivity {
            ...
            public void execute(JSONArray data) {
                for (int i = 0; i < data.length(); i++)
                {
                    try {
                        ...
                        putBookOnTable(bookID, title, author, genre, isbn, rating);
     ...
     * @author Roba Abbajabal
     */
    public void putBookOnTable(int bookID, String title, String author, String genre, String isbn, int rating) {

        Book book = new Book(bookID, title, author, genre, -1, isbn, rating, -1, null, null);
